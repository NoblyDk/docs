...
description: "Understand reporting dashboards in Nobly Insight — how data sources, dashboards, and elements fit together for the people who build and view them."
icon: "chart-line"
---
...
<Steps>
  <Step title="Data source">
    A named, saved query that returns rows and columns. You author it once; every element that needs that data points at it. See [Data sources](/reporting/data-sources).
  </Step>

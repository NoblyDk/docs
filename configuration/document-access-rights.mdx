...
You manage them under **Settings → Admin → Documents → Access rights**. Edit them two ways:
...
1. Open **Settings → Admin → Documents → Access rights** and choose the **by document type** or **by group** view.

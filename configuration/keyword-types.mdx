...
<Frame>
  <img src="/images/config-keyword-types-list.png" alt="Keyword types list under Admin settings, Keywords, showing data type, length and dataset columns and a New keyword type button" />
</Frame>

...
You configure all of it under **Settings → Admin**, split across the **Documents** and **Keywords** areas. These screens are for administrators — changing them affects how every user uploads, indexes, and searches documents.

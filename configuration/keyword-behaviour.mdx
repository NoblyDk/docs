...
<Frame>
  <img src="/images/config-keyword-assignments.png" alt="Keyword assignment editor showing each assigned keyword's required, hidden, read-only, unique, required-for-retrieval, and default value controls" />
</Frame>
...
<Frame>
  <img src="/images/config-keyword-behaviour.png" alt="The Keyword behavior settings page showing global keyword behaviour options and keyword conditional rules" />
</Frame>

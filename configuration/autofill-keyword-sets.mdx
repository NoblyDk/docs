...
Manage them under **Settings → Admin → Keywords → Autofill sets**. The list shows each set's primary keyword, its other members, the user groups that can use it, and how many value rows it holds.
...
1. Open **Settings → Admin → Keywords → Autofill sets** and choose **New autofill set**.
